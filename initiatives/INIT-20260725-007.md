...
**Priority:** Critical
**Status:** Open
**Intelligence:** Decision Authority — KSN-as-Board-Chairman implies board-level authority; specific delegated authority NOT documented. OSINT-unresolvable. (Source: CJ-1, Aug 3 report)
...
**Intelligence:** Warm Introduction Path — RESOLVED. NACSA CE primary-source confirmed; CSCDC = NACSA operational arm; JPM/KSN path most evidenced. AISE26 keynote bridge verified. (Source: CJ-1, Aug 3 report)
...
**Priority:** Critical
**Status:** Open
**Intelligence:** Mobilisation Timeline (weekly milestones) — internal/non-public planning document. OSINT-unresolvable. (Source: CJ-1, Aug 3 report)
...
|--------|----------|---------------------------|
| PIR-INIT-CSCDC-001 | critical | Internal delegated-authority question |
| PIR-INIT-CSCDC-003 | critical | Internal planning document |
