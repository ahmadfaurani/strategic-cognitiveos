---
id: INIT-20260820-004
record_type: initiative
title: Job Description — Project Manager, Cyber Security Practice
created_at: 2026-08-23 16:20:00+00:00
owner: faurani-jaafar
status: active
portfolio_tier: flagship
readiness_level: concept
summary: "Job description for TBH-001 — Project Manager role within the Cyber Security Practice, reporting to Hadri (Practice COO). Owns execution coordination of POC documents, technical deliverable tracking, and operational POC delivery. Resolves ACT-20260820-004 blocking condition."
...
updated_at: '2026-08-23T16:20:00+00:00'
priority: critical
confidence: medium
source:
  type: direct
...
Own the execution coordination of cybersecurity practice deliverables — starting with POC documents, technical briefs, and client-facing project artefacts — ensuring they are produced on schedule, to quality, and with the right contributors. This role exists to take project execution coordination off DAF's plate and embed it structurally under the Practice COO. Without this role, DAF carries PM duties by default, creating the exact execution scalability bottleneck the TBH Registry was designed to surface.
...
### POC Document Execution (Immediate — ACT-20260820-004)

- Coordinate the production of the 8-section VoronCitadel POC document for Bursa Malaysia, ensuring each section owner delivers on schedule:
  - **DAF-owned sections** (1, 4, 6, 7, 8): Track progress, flag delays, ensure approval-ready by deadline
  - **Hadri-owned sections** (2, 3, 5): Coordinate technical input, ensure Fuad's product capability input is incorporated, manage review cycles
  - **Fuad input** (Section 2 — product capabilities, use cases): Ensure timely contribution
- Manage the document review cycle: Athena (author) → Fuad (technical review) → DAF (approval) → final
- Maintain the document status tracker: section-by-section status, owner, deadline, review state, blockers
- Ensure document is ready for Monday 10am MYT deep dive session (Aug 24)

### POC Execution Coordination (Ongoing)

- For each POC engagement through the CSM channel:
  - Maintain the POC project plan: scope, milestones, owners, dependencies, risks
  - Coordinate technical deliverable production across Hadri (architecture), Fuad (product), and POC Engineer (environment/delivery)
  - Track POC readiness: environment provisioned, data loaded, integration scoped, success criteria defined
  - Run weekly POC status checks with the delivery team — surface blockers early
  - Produce POC status reports for DAF and Hadri: progress, risks, decisions needed

### Deliverable Management

- Maintain the practice deliverables register: what's in production, who owns it, deadline, status, review state
- Enforce the WIP Protocol: identify creation owner, audience, strategic/operational/tactical importance, and 7-working-day TAT (3 creation + 2 QC + 1 approval) for every new document
- Track documents through the 4-role execution map: Creation → QC → Approval → Execution
- Flag TBH dependencies: if a deliverable is blocked because a role isn't filled, log it in the TBH Registry

### Cross-Functional Coordination

- Primary operational liaison between Practice (Hadri), Product (Fuad), and Director (DAF) for deliverable production
- Coordinate with the GTM Delivery Owner on POC-to-commercial transition: ensure POC documentation feeds smoothly into commercial proposal production
- Work with the POC Engineer to ensure technical environment readiness aligns with document timeline
- Flag resource conflicts to Hadri (COO) before they become blockers

### Quality & Standards

- Ensure all POC documents follow the 8-section structure (per DEC-20260820-004) or equivalent approved templates
- Ensure claims in client-facing documents pass claims review before external distribution
...
- Malaysian regulatory awareness — familiarity with RMiT, SC GTRM, PDPA, BNM guidelines (enough to understand document context, not to author technical content)
...
### Immediate (Week 1 — Aug 24-30)
- VoronCitadel POC document for Bursa Malaysia delivered on time, approved, and ready for Monday 10am MYT deep dive session
- Document status tracker operational — all 8 sections tracked with owner, deadline, review state
- Practice deliverables register established — all in-flight deliverables visible

### Short-term (30 days)
- POC project plan template created and approved by Hadri + DAF
- Weekly POC status check cadence established with the delivery team
...
### Medium-term (90 days)
- At least 2 POC engagements coordinated end-to-end with documented status reporting
- Zero deliverables without a named owner and deadline
- POC-to-commercial handoff process documented and tested with the GTM Delivery Owner
- Lessons learned captured from each POC and fed back into template improvements
- DAF's PM coordination load reduced by at least 70% — DAF reviews and approves, does not chase or coordinate

---

## Working Relationships

| Internal | Role in POC Delivery |
|----------|---------------------|
| **Hadri** (Practice COO — line manager) | Technical content owner (Sections 2, 3, 5); escalation point for resource conflicts |
| **DAF** (Director — matrix) | Strategic content owner (Sections 1, 4, 6, 7, 8); final approver; sets priorities |
| **Fuad** (Product Owner) | Product capability input (Section 2); POC environment owner via POC Engineer |
| **POC Engineer** (TBH — under Fuad) | Technical environment provisioning and POC delivery |
| **GTM Delivery Owner** | POC-to-commercial transition coordination; GTM pipeline alignment |
...
| External | Role |
|----------|------|
| CSM counterparts | POC coordination for joint accounts |
...
This separation is deliberate: it prevents DAF from becoming the default coordination point (the current bottleneck) and embeds execution discipline structurally within the COO's org.

---

## Relationship to Existing JDs
