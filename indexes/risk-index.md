...
| RSK-20260820-005 | chain:SENTRY: Four supplier credentials exposed and unrotated — Critical exposure window open | security | INIT-20260811-001 | Occurred | Critical | Critical | Mitigated — rotation operator-confirmed Sep 8 |
...
| RSK-20260908-001 | CYBERDSA Compression — LOI (Sep 30) + PDPA (Sep 19) land after event-invitation window (W1–W2); 15 pre-booked meetings at risk | schedule/dependency-chain | INIT-20260908-001 | High | High | High | Active |
...
| RSK-20260915-001 | WIG marketing bandwidth constraint — concurrent subsidiary GTM/comms programmes dilute VoronCitadel execution capacity; interns proposed (Azza, 15 Sep) | delivery-capacity | INIT-20260908-001 | Medium | Medium | High | Monitoring |
...
_Updated 2026-08-10: Full register refresh. 10 Aug 2 risks status-updated (Identified → Mitigating/Active). RSK-04-002 linked to RSK-10-001 (Hadi = senior GovSec resource). 2 new risks added: RSK-20260810-002 (security hardening gap), RSK-20260810-003 (commercial readiness gap). Risk relationships mapped. Maintenance cadence established. Updated 2026-08-22: Added RSK-20260822-001 (operational follow-through gap, ACT-20260810-001 12 days overdue, blocks Wan Roshaimi co-branding credibility). Added RSK-20260822-002 (vendor-detection risk, Wan Roshaimi distinguishes engineering from marketing, overclaiming triggers credibility collapse). Added RSK-20260822-003 (GTM conversion timeline compression, Layers 1-2 quiet until Oct, only 2 months for conversion). Added RSK-20260822-004 (Marketing capacity gap, 1,300-contact outreach exceeds current bandwidth, Norshaza flagged Aug 11). Added RSK-20260822-005 (MQL channel attribution gap, CSM co-branding MQLs have no named owner). Added RSK-20260822-006 (MQL volume shortfall, if marketing commits below 78, funnel math breaks). Added 2026-08-23: RSK-20260823-002 (Gate 0 Roshdi status unverified, may block Gate 2 closure at Wednesday working group). Added 2026-08-27: RSK-20260827-001 (RSWG compliance window competitive risk — first mover advantage at risk if VoronCitadel POC delays). **2026-08-28:** Added RSK-20260828-001 (NDA IP terms negotiation risk — 4 critical provisions may require reconciliation with CSM, medium likelihood, high impact, compresses competitive window). **2026-09-08:** Added RSK-20260908-001 (CYBERDSA compression — LOI/PDPA sequence after invitation window; mitigation: decouple booking from LOI via Sales/Practice relationship track) and RSK-20260908-002 (78-MQL governing model unresolved, 413×19% vs 1,300-matrix, DISPUTED; contact bases 413/513/493 unreconciled) — both spawned from GTM Marketing Execution Plan intake (CONV-20260908-002). **2026-09-15 09:58 UTC:** Added RSK-20260915-001 (WIG marketing bandwidth — CMO-flagged same-day as plan approval; concurrent subsidiary GTM/comms load; intern relief proposed, quantification pending ACT-20260915-004; source CONV-20260915-002)._
